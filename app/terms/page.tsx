          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-white/90">
              ...
              <div className="space-y-6">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4">3. Enrollment Process</h2>
                  <p className="leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4">6. Cancellation and Refunds</h2>
                  <ul className="list-disc list-inside space-y-2 leading-relaxed">
