...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Comprehensive immigration services by MYST - expert MARA & RCIC certified consultants. Get Canada PR, Australia PR, USA work visas, and study abroad guidance.",
