...
export default function EligibilityForm() {
  ...
  return (
    <BentoCard className="p-6 md:p-8 lg:p-12 bg-gradient-to-br from-primary/20 to-accent/10 min-h-[600px]">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <BentoDescription className="text-lg text-white/90">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="eligibility-name" className="block text-sm font-medium text-white/90 mb-2">
                Full Name *
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                name="country"
                required
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-primary/50 focus:bg-white/15 transition-all"
              >
                <option value="" className="bg-gray-800 text-white">Select preferred country</option>
            ...
            <div>
              <label htmlFor="education" className="block text-sm font-medium text-white/90 mb-2">
                Highest Education *
              </label>
              <select
                id="education"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="occupation" className="block text-sm font-medium text-white/90 mb-2">
                Current Occupation *
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="eligibility-email" className="block text-sm font-medium text-white/90 mb-2">
                Email Address *
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="eligibility-phone" className="block text-sm font-medium text-white/90 mb-2">
                Phone Number *
              </label>
              <input
                type="tel"
          ...
          {/* IELTS Score */}
          <div>
            <label htmlFor="ielts" className="block text-sm font-medium text-white/90 mb-2">
              IELTS Score (if any)
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <label
                htmlFor="resume"
                className="w-full px-4 py-6 bg-white/5 border-2 border-dashed border-white/20 rounded-lg text-white/70 hover:bg-white/10 hover:border-primary/40 transition-all cursor-pointer flex flex-col items-center justify-center"
              >
                <Upload className="h-8 w-8 mb-2 text-primary" />
                {uploadedFile ? (
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400" />
                    <span className="text-sm text-white/90">{uploadedFile.name}</span>
                  </div>
                ) : (
                  <>
